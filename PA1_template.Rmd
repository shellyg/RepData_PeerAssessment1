...
The calculated mean and median for the total number of steps taken per day, both with missing data and after replacing the missing values, are shown below.  Comparison of the 
